...
def home(request):     #function based view 
    context={
        #now this posts key and the data can be used inside the home.html templates
...
class UserPostListView(ListView):     #class based view
    model=Post
    template_name='blog/user_posts.html'     # <app>/<model>_<viewtype>.html      example: blog/post_list.html
    context_object_name='posts'
    paginate_by=5
